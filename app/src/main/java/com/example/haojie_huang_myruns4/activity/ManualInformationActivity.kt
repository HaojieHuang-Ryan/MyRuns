...
class ManualInformationActivity: AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.activity_manual_information_display)

        //Replace toolbar
        val toolbar: Toolbar = findViewById(R.id.displaceToolbar)
